...
class AuthorExtractorV3:
    """
    AuthorExtractor v3.0
    Работи с AuthorModel-v3.0.json
    Разделен на модули според архитектурата на v3.
    """
    ...
    def extract_name_original(self):
        ...
        Ако е чужд → логиката ще бъде добавена по-късно.
        """
    ...
    def run(self, url: str) -> dict:
        """
        Основен pipeline за извличане на данни.
        """
