...
Постовете са **основният източник на съдържание** в списанието и съдържат:
...
### ✔ 4) Да съдържат рецензии и представяния на книги  
### ✔ 5) Да предоставят биографична информация (ако липсва другаде)

Постовете са **най-богатият източник на данни** след WordPress Pages.

---

## 3. Данни, които се извличат от всеки пост

Екстракторът извлича следните елементи:
...
Ако постът съдържа биографичен блок (например в края):
...
### 6.1 Разпознаване
Artwork се извлича от:

- изображения в съдържанието  
- featured image (ако е художествено)  
...
### 7.1 Разпознаване
Пост е свързан с книга, ако:

- съдържа корица на книга  
- съдържа ISBN  
- съдържа ключови думи („роман“, „поетична книга“, „сборник“)  
- е в категория „Книги“ (ако съществува)  
- е рецензия или представяне  
...
Това е допустимо, но екстракторът докладва:
```
...
Това е нормално — не се счита за несъответствие.
...
- рецензии и представяния на книги  
